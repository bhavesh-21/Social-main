...
CORS(app)
app.config.update(
    CELERY_BROKER_URL='redis://default:kNCdCuepSrNjOFFTsjWqMQHkCtrSoGFd@monorail.proxy.rlwy.net:24813',
    CELERY_RESULT_BACKEND='redis://default:kNCdCuepSrNjOFFTsjWqMQHkCtrSoGFd@monorail.proxy.rlwy.net:24813'
)
